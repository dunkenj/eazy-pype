...
prior_fname = 'ukidssK_mag' #'swire36_mag' #'pani_mag' #
prior_colname = 'ukidssK_mag' #'swire36_mag' # 'pani_mag' #
alpha_colname =  'ukidssK_mag' #'swire36_mag' # 'pani_mag' #
