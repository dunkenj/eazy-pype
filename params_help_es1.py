...
working_folder = '/data2/ken/HELP/ES1'
photometry_catalog = 'master_catalogue_elais-s1_20180221_processed.fits'
photometry_format = 'fits'

filter_file = 'ES1_filters.res'
translate_file = 'ES1.translate'
